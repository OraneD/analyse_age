...
for i from 1 to nstrings
    ...
    for intervalNumber to numberOfIntervals
	   ...
	   Save as text file: "D:\\Memoire\\corpus_mfa_1channel\\" + folderbaseName$ + "\\" + baseName$ + "_" + string$(intervalNumber) + ".TextGrid"
	   Remove

	   selectObject: "Sound " +  baseName$
	   Extract part: startTime, endTime, "rectangular", 1, "no"
	   Save as WAV file: "D:\\Memoire\\corpus_mfa_1channel\\" + folderbaseName$ + "\\" + baseName$ + "_" + string$(intervalNumber) + ".wav"
           Remove
